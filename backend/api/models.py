...
class MaintenanceRequest(models.Model):
    ...
    notes = models.TextField(blank=True, null=True)
    photo = models.FileField(upload_to='maintenance_photos/', blank=True, null=True)
...
class UserProfile(models.Model):
    ...
    tenant = models.ForeignKey(Tenant, on_delete=models.SET_NULL, null=True, blank=True, related_name='user_account')
